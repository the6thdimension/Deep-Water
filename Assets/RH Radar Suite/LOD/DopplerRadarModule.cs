        ...
        private void PerformDopplerScan()
        {
            ...
            for (int i = 0; i < targetsFound; i++)
            {
                ...
                if (contacts.TryGetValue(target, out RadarContact contact))
                {
                    ...
                    contact.Update(target.transform.position, signalStrength, RadarLOD.LOD3_DopplerRadar);
                ...
                else
                {
                    ...
                    contact.Update(detectedPosition, signalStrength, RadarLOD.LOD3_DopplerRadar);
